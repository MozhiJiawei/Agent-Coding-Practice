...
BMAD 框架系统目录，包含代理定义、工作流模板、任务配置及核心模块。属于框架基础设施，通常无需手动修改。

### _bmad/core/tasks/

- **[_bmad/core/tasks/index-docs.xml](./_bmad/core/tasks/index-docs.xml)** - 生成目录索引的任务定义
- **[_bmad/core/tasks/shard-doc.xml](./_bmad/core/tasks/shard-doc.xml)** - 文档拆分任务定义
- **[_bmad/core/tasks/workflow.xml](./_bmad/core/tasks/workflow.xml)** - 通用工作流执行任务
- **[_bmad/core/tasks/editorial-review-prose.xml](./_bmad/core/tasks/editorial-review-prose.xml)** - 文档散文质量审查任务
- **[_bmad/core/tasks/editorial-review-structure.xml](./_bmad/core/tasks/editorial-review-structure.xml)** - 文档结构审查任务
- **[_bmad/core/tasks/review-adversarial-general.xml](./_bmad/core/tasks/review-adversarial-general.xml)** - 对抗性通用审查任务
- **[_bmad/core/tasks/help.md](./_bmad/core/tasks/help.md)** - 核心任务帮助说明
